...
public class FiltersTest {
    ...
    public void shouldRedundancyFilterEliminateRepeatedPoints() throws BlueprintNotFoundException, BlueprintPersistenceException {
        ...
        Point[] andres = new Point[] { new Point(40, 40), new Point(15, 15), new Point(40, 40), new Point(40, 40),
                new Point(15, 15), new Point(15, 15) };
        Point[] arias = new Point[] { new Point(15, 14) };
        Blueprint bp0 = new Blueprint("andres", "hola", andres);
        Blueprint bp1 = new Blueprint("arias", "adios", arias);
    ...
    public void shouldRedundancyFilterEliminateRepeatedPointsForMoreThanOneBlueprint() throws BlueprintNotFoundException, BlueprintPersistenceException {
        ...
        Point[] andres= new Point[] { new Point(40, 40), new Point(15, 15), new Point(40, 40), new Point(40, 40),
                new Point(15, 15), new Point(15, 15) };
        Point[] sebastian = new Point[] { new Point(15, 14) };
        Blueprint bp0 = new Blueprint("juan", "hola", andres);
        Blueprint bp1 = new Blueprint("pablo", "adios", sebastian);
        Blueprint bp2 = new Blueprint("sebastian", "prueba", new Point[] {});
        ...
        Assert.assertEquals(6, ((Blueprint) blueprintsCo[0]).getPoints().size());
    ...
    public void shouldSubsamplingFilterEliminateSubsamplingPoints() throws BlueprintNotFoundException, BlueprintPersistenceException {
        ...
        Point[] andres = new Point[] { new Point(10, 10), new Point(14, 12), new Point(19, 20), new Point(34, 25),
                new Point(1, 4),
                new Point(14, 18), new Point(1, 4), new Point(9, 80), new Point(8, 7), new Point(14, 25) };
        Point[] sebastian = new Point[] { new Point(1, 2), new Point(2, 6) };
        Blueprint bp0 = new Blueprint("juan", "hola", andres);
        Blueprint bp1 = new Blueprint("pablo", "adios", sebastian);
        Blueprint bp2 = new Blueprint("sebastian", "prueba", new Point[] {});
        try {
    ...
    public void shouldSubsamplingFilterEliminateSubsamplingPointsForMoreThanOneBlueprint() throws BlueprintNotFoundException, BlueprintPersistenceException {
        SubsamplingFilter fs = new SubsamplingFilter();
        Point[] sebastian = new Point[] { new Point(10, 10), new Point(14, 12), new Point(19, 20), new Point(34, 25),
                new Point(1, 4),
                new Point(14, 18), new Point(1, 4), new Point(9, 80), new Point(8, 7), new Point(14, 25) };
        Point[] andres = new Point[] { new Point(1, 2), new Point(2, 6) };
        Blueprint bp0 = new Blueprint("juan", "hola", sebastian);
        Blueprint bp1 = new Blueprint("pablo", "adios", andres);
        Blueprint bp2 = new Blueprint("sebastian", "prueba", new Point[] {});
        Set<Blueprint> blueprints = new HashSet<Blueprint>();
        blueprints.add(bp0);
        blueprints.add(bp1);
